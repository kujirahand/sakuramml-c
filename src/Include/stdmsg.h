...
================================================================================
=title        "stdmsg.h" ver.3.00
=description  標準的な命令を定義したファイル。自動的に読み込む仕組み。
--------------------------------------------------------------------------------
[履歴]
- 2000/03/22 ver.1.32 標準的な音源操作命令を定義した。
- 2003/01/25 ver.1.40 XG音源に特化した不要な命令を削除し、コメント等を付け加えた
- 2014/12/28 ver.3.00 Sakura3用に文字コード変更した上に全体に整理
------------------------------------------------------------------------------*/
